...
try:
    masks, flows, styles, diams = model.eval([img], channels=channels, rescale=None, diameter=150, flow_threshold=.9, mask_threshold=.25, resample=True, diam_threshold=100)
except:
