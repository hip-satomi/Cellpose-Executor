...
masks, flows, styles, diams = model.eval([img], channels=channels, rescale=None, diameter=None, flow_threshold=.8, mask_threshold=.25, resample=True, diam_threshold=100)
